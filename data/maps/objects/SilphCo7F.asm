...
SilphCo7F_Object:
	...
	object_event 13,  1, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO7F_ROCKET1, ROCKET, 32
	object_event  2, 13, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO7F_SCIENTIST, SCIENTIST, 8
	object_event 20,  2, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO7F_ROCKET2, ROCKET, 33
	object_event 19, 14, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO7F_ROCKET3, ROCKET, 34
